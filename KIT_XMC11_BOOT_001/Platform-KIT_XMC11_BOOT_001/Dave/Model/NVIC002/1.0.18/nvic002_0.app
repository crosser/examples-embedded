...
3 is least priority equivalent to 192</toolTipHelpDescription>
  ...
  <provided xsi:type="ResourceModel:StringParameter" name="User defined interrupt handler" evalFunction="" URI="http://www.infineon.com/1.0.18/app/nvic002/0/nvic002_srwuserfunction">
    ...
    <localValue xsi:type="ResourceModel:StringValue" value="rxIsr"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="rxIsr"/>
