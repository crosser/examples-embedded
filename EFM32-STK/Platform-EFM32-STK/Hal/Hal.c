...
#define BUTTON_PIN              9
#define BUTTON_IRQn             GPIO_ODD_IRQn
#define BUTTON_IRQHandler       GPIO_ODD_IRQHandler
...
#define EAP_RX_ACK_PIN          5
#define EAP_TX_PORT             gpioPortD
#define EAP_TX_PIN              0
#define EAP_TX_ACK_PORT         gpioPortC
#define EAP_TX_ACK_PIN          12
#define EAP_TX_ACK_IRQn         GPIO_EVEN_IRQn
#define EAP_TX_ACK_IRQHandler   GPIO_EVEN_IRQHandler
...
#define BUTTON_IRQn             GPIO_ODD_IRQn
#define BUTTON_IRQHandler       GPIO_ODD_IRQHandler
#define CONNECTED_LED_PORT      gpioPortE
#define CONNECTED_LED_PIN       3
#define DEBUG1_PORT             gpioPortD
#define DEBUG1_PIN              6
#define DEBUG2_PORT             gpioPortD
...
#define EAP_RX_PIN              1
#define EAP_RX_ACK_PORT         gpioPortC
#define EAP_RX_ACK_PIN          3
#define EAP_TX_PORT             gpioPortD
#define EAP_TX_PIN              0
#define EAP_TX_ACK_PORT         gpioPortC
#define EAP_TX_ACK_PIN          4
#define EAP_TX_ACK_IRQn         GPIO_EVEN_IRQn
#define EAP_TX_ACK_IRQHandler   GPIO_EVEN_IRQHandler
...
void Hal_buttonEnable(Hal_Handler handler) {
    ...
    Hal_delay(100);
    NVIC_EnableIRQ(BUTTON_IRQn);  // for BUTTON_PIN
}
...
void Hal_init() {
    ...
    NVIC_EnableIRQ(EAP_TX_ACK_IRQn);  // for EAP_TX_ACK
...
// Hal_txAckIsr
void EAP_TX_ACK_IRQHandler(void) {
    uint8_t b;
    GPIO_IntClear(1 << EAP_TX_ACK_PIN);
