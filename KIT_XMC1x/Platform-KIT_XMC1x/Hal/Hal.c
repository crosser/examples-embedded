/*
 * ============ Platform Configuration for XMC1x Boot Kit ============
 *
 ...
 *
 *  SIGNAL			DAVE CE		PORT	B-SMART	SETTINGS
 *  NAME			DEVICE		NUMBER	CABLE
 *  -----------------------------------------------------
 ...
 * 	LED:   			IO004/0		P0.5 on XMC11 / P0.9 on XMC13		Output Enabled, Default level High, Tristate, Push Pull
 * 	CONNECTED_LED:	IO004/1		P0.6 on XMC11 / P0.8 on XMC13		Output Enabled, Default level High, Tristate, Push Pull
 ...
 * 	EAP_RX_ACK:		IO004/4		P2.0	Yellow	Output Enabled, Default level High, Tristate, Push Pull
 * 	EAP_TX_ACK:		IO002/0		P2.1	White	Output Disabled, Tristate, Standard Hysteresis
 ...
 * 	EAP_RX + _TX:	UART001/0	P1.2/TX	Purple	Full Duplex, No Parity, One Stop Bit, 8 Data bits, RxFifo 16, TxFifo 16
 * 								P1.3/RX	Orange	Trigger Limit 1, Desired Baud Rate 115200, No Oversampling
 ...
 *
 *   - XMC1x P0.0  -- output -- DEBUG1  used optionally for debugging
 *   - XMC1x P0.1  -- output -- DEBUG2  used optionally for debugging
 *   - XMC1x P0.6 on XMC1100 / P0.8 on XMC1300  -- output -- CONNECTED_LED
 *   - XMC1x P0.5 on XMC1100 / P0.9 on XMC1300 -- output -- LED
 *   - XMC1x P1.2  -- output -- EAP_TX UART connected to A2541 module P0_3/TXD (115200,8N1N)
 *   - XMC1x P1.3  -- input  -- EAP_RX UART connected to A2541 module P0_2/RXD (115200,8N1N)
 *   - XMC1x P2.0  -- output -- EAP_RX_ACK   connected to A2541 P0_4/CTS# through BoosterPack jumper JP3-1/JP3-2
 *   - XMC1x P2.1  -- input  -- EAP_TX_ACK   connected to A2541 P0_5/RTS# through BoosterPack jumper JP4-1/JP4-2
 *   - XMC1x       -- input  -- BUTTON not implemented
 *
...
#define EMPTY_LOOPS_PER_MS          100L * (MCLK_TICKS_PER_MS / 2000L)     // constant just found experimentally
...
void Hal_init(void) {
    ...
    DEBUG2_OFF();
    DEBUG1_ON();                    // For XMC1300 Boot Kit, Debug1 is connected to low-side-driven LED.  So this turns LED off.
    DEBUG2_ON();                    // For XMC1300 Boot Kit, Debug2 is connected to low-side-driven LED.  So this turns LED off.
